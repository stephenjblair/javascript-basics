...
describe("add", () => {
  test("adds the two numbers together", () => {
...
describe("multiply", () => {
  test("multiplies the two numbers together", () => {
...
describe("power", () => {
  test("returns the first number to the power of the second", () => {
...
describe("roundUp", () => {
  test("rounds the number up to the nearest integer", () => {
...
describe("roundDown", () => {
  test("rounds the number down to the nearest integer", () => {
...
describe("quotient", () => {
  ...
  test("returns the quotient from dividing the first number by the second number", () => {
...
describe("remainder", () => {
  test("returns the remainder when dividing the first number by the second number", () => {
