...
describe("sayHello", () => {
  test('returns "Hello world!" when passed "world"', () => {
    expect(sayHello("world")).toEqual("Hello, world!");
  });

  test('returns "Hello MCR Codes!" when passed "MCR Codes"', () => {
    expect(sayHello("MCR Codes")).toEqual("Hello, MCR Codes!");
  });

  test('returns "Hello fsghjdfkhgf!" when passed "fsghjdfkhgf"', () => {
    expect(sayHello("fsghjdfkhgf")).toEqual("Hello, fsghjdfkhgf!");
  });
});

describe("uppercase", () => {
  test("returns the uppercased string", () => {
...
describe("lowercase", () => {
  test("returns the lowercased string", () => {
...
describe("firstCharacter", () => {
  test("returns the first character of the string", () => {
...
describe("firstCharacters", () => {
  test("returns the first 4 characters of the string", () => {
    expect(firstCharacters("sd32fg45", 4)).toEqual("sd32");
  });

  test("returns the first 2 characters of the string", () => {
