...
describe("createPerson", () => {
  test("creates an object with the given name and age properties", () => {
...
describe("getProperty", () => {
  test("returns the given property", () => {
    expect(
      getProperty("age", {
        name: "Fred",
        age: 79
...
describe("hasProperty", () => {
  ...
  test("returns true if the object has the given property", () => {
...
describe("isOver65", () => {
  test("returns true if the person is aged over 65", () => {
    const jim = {
      name: "Jim",
      age: 66
    };
...
describe("getAges", () => {
  test("returns the ages of each person in the array", () => {
    const jim = {
      name: "Jim",
      age: 66
    };
...
describe("findByName", () => {
  test("returns the person with the given name", () => {
    const jim = {
      name: "Jim",
      age: 66
    };
...
describe("findHondas", () => {
  test("returns a list of cars manufactured by Honda", () => {
    const car1 = {
      manufacturer: "Honda",
      year: 1997,
      colour: "blue"
...
describe("averageAge", () => {
  test("returns the average age of the people in the list", () => {
    const john = {
      name: "John",
      age: 60
    };
...
describe("createTalkingPerson", () => {
  test("returns a person who can introduce themselves", () => {
