...
describe("both", () => {
  test("returns true if both of the given values are true", () => {
...
describe("either", () => {
  test("returns true if at least one of the given values are true", () => {
...
describe("none", () => {
  test("returns true if neither of the given values are true", () => {
...
describe("one", () => {
  test("returns true if exactly one of the given values are true", () => {
...
describe("truthiness", () => {
  test("returns the truthiness of the given value", () => {
...
describe("isEqual", () => {
  test("returns whether the two values are even", () => {
...
describe("isGreaterThan", () => {
  test("returns true if the first number is strictly greater than the second", () => {
...
describe("isLessThanOrEqualTo", () => {
  test("returns true if the first number is less than or equal to the second", () => {
...
describe("isOdd", () => {
  test("returns whether the number is odd", () => {
...
describe("isEven", () => {
  test("returns whether the number is even", () => {
...
describe("isSquare", () => {
  test("returns true if the number is a square", () => {
...
describe("startsWith", () => {
  test("returns whether the given string starts with the given character", () => {
...
describe("containsVowels", () => {
  test("returns whether the given string contains vowels", () => {
...
describe("isLowerCase", () => {
  test("it returns true if the given string is lowercase", () => {
