...
describe("getNthElement", () => {
  ...
  test("returns the element at the given position", () => {
  ...
  test("if n is greater than the number of elements, it cycles back to the start", () => {
...
describe("arrayToCSVString", () => {
  test("returns the array elements as a comma-seperated string", () => {
...
describe("csvStringToArray", () => {
  test("converts the csv string as an array", () => {
...
describe("addToArray2", () => {
  test("returns a new array with the value appended", () => {
    const array = ["a", "b", "c"];
    const array2 = [1, 2, 3];
...
describe("removeNthElement", () => {
  test("removes the element at position n", () => {
...
describe("numbersToStrings", () => {
  test("converts every number in the array to a string", () => {
    expect(numbersToStrings([1, 2, 3])).toEqual(["1", "2", "3"]);
  });
});

describe("uppercaseWordsInArray", () => {
  test("makes every string in the array uppercase", () => {
...
describe("reverseWordsInArray", () => {
  test("reverses every string in an array", () => {
...
describe("onlyEven", () => {
  test("filters the array and only returns even numbers", () => {
    expect(onlyEven([1, 2, 3, 4, 5, 6, 7, 8])).toEqual([2, 4, 6, 8]);
  });
});

describe("removeNthElement2", () => {
  test("returns an array with the nth element removed, and does not mutate the original", () => {
...
describe("elementsStartingWithAVowel", () => {
  test("returns elements starting with a vowel", () => {
    expect(
      elementsStartingWithAVowel([
        "apple",
        "bapple",
...
describe("removeSpaces", () => {
  test("returns the string with the space characters removed", () => {
...
describe("sumNumbers", () => {
  test("returns the sum of the numbers in the array", () => {
    expect(sumNumbers([1, 3, 5, 6, 2, 8])).toEqual(25);
  });
});

describe("sortByLastLetter", () => {
  test("sorts the string by the last character", () => {
    expect(
